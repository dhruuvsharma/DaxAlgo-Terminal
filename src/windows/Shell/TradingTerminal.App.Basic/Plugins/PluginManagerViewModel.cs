...
public sealed partial class PluginManagerViewModel : ViewModelBase
{
    ...
    private void Rebuild()
    {
        ...
        // Strategies authored in the local builder this session: running now, written to the plugins
        // folder, and loaded like any other plugin on the next start. They are unsigned by definition.
