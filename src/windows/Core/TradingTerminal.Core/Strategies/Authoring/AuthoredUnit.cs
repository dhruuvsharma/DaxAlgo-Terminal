...
///
/// <para>Authoring targets <c>IStrategyKernel</c> and <c>IVisualizer</c>. <c>IOrderRoutedStrategy</c> is
...
/// <param name="UsesRetiredContract">True when the type was found through <c>IOrderRoutedStrategy</c>.</param>
