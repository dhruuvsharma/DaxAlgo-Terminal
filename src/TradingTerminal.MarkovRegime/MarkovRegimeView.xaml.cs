...
public partial class MarkovRegimeView : UserControl
{
    ...
    {
        InitializeComponent();
        // Match the app's dark theme — without this the ScottPlot host renders on its default
        // white figure/data background. Styling persists across Plot.Clear() on redraw.
        StrategyChartHelpers.ConfigureDarkPlot(RegimePlot);
