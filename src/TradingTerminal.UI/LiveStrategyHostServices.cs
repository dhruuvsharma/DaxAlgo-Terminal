...
///
/// <list type="bullet">
/// <item><see cref="Repository"/> — still used for <see cref="IMarketDataRepository.ListInstrumentsAsync"/>
...
/// <c>SubscribeBars</c> to ensure the active broker's feed is started; the handle releases on dispose.</item>
