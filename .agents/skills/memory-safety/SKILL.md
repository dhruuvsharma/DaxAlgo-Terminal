...
The Stop hook `.Codex/hooks/leakcheck-on-stop.ps1` scans changed `.cs` for these patterns and blocks
...
powershell -NoProfile -ExecutionPolicy Bypass -File .Codex\hooks\leakcheck-on-stop.ps1 -All
```
