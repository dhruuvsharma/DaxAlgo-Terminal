...
**Path** `src/windows/Backtest/TradingTerminal.Backtest.Engine/` · **Editions** B I P · **Blast: med**
...
A consuming overlay may add a headless CLI consumer; use its workspace guide for downstream impact.
