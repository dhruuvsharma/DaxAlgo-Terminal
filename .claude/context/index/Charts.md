...
| `src/windows/Charts/TradingTerminal.Charts/ChartsPanel.xaml` | 160 | win | TradingTerminal.Charts | B I P | N | XAML |
...
| `src/windows/Charts/TradingTerminal.OrderBook/OrderBookPanel.xaml` | 493 | win | TradingTerminal.OrderBook | B I P | N | XAML |
...
| `src/windows/Charts/TradingTerminal.VolumeFootprint/VolumeFootprintPanel.xaml` | 445 | win | TradingTerminal.VolumeFootprint | B I P | N | XAML |
