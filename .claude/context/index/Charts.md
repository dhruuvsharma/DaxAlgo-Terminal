...
| `src/windows/Charts/TradingTerminal.Charts/ChartsViewModel.cs` | 535 | win | TradingTerminal.Charts | B I P | Y | Non-null when this view-model lives inside a strategy window rather than the |
| `src/windows/Charts/TradingTerminal.Charts/ChartsWindow.xaml.cs` | 20 | win | TradingTerminal.Charts | B I P | Y | The standalone Charts window: a frame around with every feature on. The |
...
| `src/windows/Charts/TradingTerminal.Heatmap/AvaloniaUi/BookmapHeatmapAvaloniaWindow.axaml` | 46 | win | TradingTerminal.Heatmap | B I P | N | XAML |
...
| `src/windows/Charts/TradingTerminal.OrderBook/AvaloniaUi/OrderBookAvaloniaWindow.axaml` | 69 | win | TradingTerminal.OrderBook | B I P | N | XAML |
...
| `src/windows/Charts/TradingTerminal.OrderBook/OrderBookWindow.xaml.cs` | 21 | win | TradingTerminal.OrderBook | B I P | Y | The standalone Order Book window: a frame around with every feature on. |
...
| `src/windows/Charts/TradingTerminal.VolumeFootprint/AvaloniaUi/VolumeFootprintAvaloniaWindow.axaml` | 45 | win | TradingTerminal.VolumeFootprint | B I P | N | XAML |
...
| `src/windows/Charts/TradingTerminal.VolumeFootprint/VolumeFootprintWindow.xaml.cs` | 21 | win | TradingTerminal.VolumeFootprint | B I P | Y | The standalone Volume Footprint window: a frame around with every |
