...
| `src/windows/UI/TradingTerminal.Settings/Authoring/StrategyAuthoringViewModel.cs` | 149 | win | TradingTerminal.Settings | B I P | Y | Auto-generated editor for the compiled strategy's tunables, or null when it |
...
| `src/windows/UI/TradingTerminal.UI.Core/Strategies/StrategyFactory.cs` | 53 | win | TradingTerminal.UI.Core | B I P | Y | DI-backed factory. Each registered strategy must also register a |
