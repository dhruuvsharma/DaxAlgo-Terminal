...
| `src/windows/UI/TradingTerminal.Settings/Archive/TelegramArchiveCredentialProtection.cs` | 49 | win | TradingTerminal.Settings | B I P | Y | Protection helpers for Telegram archive credentials. On Windows the secret is encrypted |
...
| `src/windows/UI/TradingTerminal.UI.Core/Catalog/StrategyCatalogViewModel.cs` | 52 | win | TradingTerminal.UI.Core | B I P | Y | Human-readable detail block for the currently selected strategy. |
...
| `src/windows/UI/TradingTerminal.UI.Core/UiFile.cs` | 21 | win | TradingTerminal.UI.Core | B I P | Y | Show an open-file picker. |
