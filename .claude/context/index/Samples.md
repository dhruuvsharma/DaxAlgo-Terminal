# index/Samples — per-file index (Windows tree)
...
|---|---|---|---|---|---|---|
| `samples/DaxAlgo.SamplePlugin/SamplePlugin.cs` | 61 | win | DaxAlgo.SamplePlugin | dev | Y | Catalog descriptor — the metadata the Strategies pane renders. |
