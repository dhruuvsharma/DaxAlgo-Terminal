...
| `src/windows/Tools/TradingTerminal.BacktestStudio/BacktestStudioView.xaml.cs` | 139 | win | TradingTerminal.BacktestStudio | B I P | Y | Code-behind for the Studio. Pure view concern: it listens for the VM's |
| `src/windows/Tools/TradingTerminal.BacktestStudio/BacktestStudioView.xaml` | 387 | win | TradingTerminal.BacktestStudio | B I P | N | XAML |
| `src/windows/Tools/TradingTerminal.BacktestStudio/BacktestStudioViewModel.cs` | 580 | win | TradingTerminal.BacktestStudio | B I P | Y | Exports the round-trip trades of the last single run. |
...
| `src/windows/Tools/TradingTerminal.Correlation/CorrelationMatrixWindow.xaml.cs` | 36 | win | TradingTerminal.Correlation | B I P | Y | Standalone window hosting the Correlation Matrix tool. Pure view — all behaviour |
