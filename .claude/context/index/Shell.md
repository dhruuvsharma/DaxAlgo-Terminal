...
|---|---|---|---|---|---|---|
| `src/windows/Shell/TradingTerminal.Accounts/AccountGateCoordinator.cs` | 233 | win | TradingTerminal.Accounts | B I P | Y |  |
| `src/windows/Shell/TradingTerminal.Accounts/AccountGateDiagnostics.cs` | 51 | win | TradingTerminal.Accounts | B I P | Y |  |
| `src/windows/Shell/TradingTerminal.Accounts/AccountGateEditionProfile.cs` | 25 | win | TradingTerminal.Accounts | B I P | Y |  |
| `src/windows/Shell/TradingTerminal.Accounts/AccountGateRunner.cs` | 101 | win | TradingTerminal.Accounts | B I P | Y | Clears the DPAPI-protected local account session and forces the next gate invocation |
| `src/windows/Shell/TradingTerminal.Accounts/AccountGateServices.cs` | 411 | win | TradingTerminal.Accounts | B I P | Y |  |
| `src/windows/Shell/TradingTerminal.Accounts/AccountGateViewModel.cs` | 255 | win | TradingTerminal.Accounts | B I P | Y |  |
| `src/windows/Shell/TradingTerminal.Accounts/AccountGateWindow.xaml.cs` | 26 | win | TradingTerminal.Accounts | B I P | Y |  |
| `src/windows/Shell/TradingTerminal.Accounts/AccountGateWindow.xaml` | 197 | win | TradingTerminal.Accounts | B I P | N | XAML |
| `src/windows/Shell/TradingTerminal.Accounts/DevelopmentAccountSessionStore.cs` | 185 | win | TradingTerminal.Accounts | B I P | Y |  |
| `src/windows/Shell/TradingTerminal.Accounts/GoogleOAuthClient.cs` | 615 | win | TradingTerminal.Accounts | B I P | Y |  |
| `src/windows/Shell/TradingTerminal.Accounts/PlatformEntitlementService.cs` | 510 | win | TradingTerminal.Accounts | B I P | Y |  |
| `src/windows/Shell/TradingTerminal.App.Basic/App.xaml.cs` | 351 | win | TradingTerminal.App.Basic | B | Y | Friendly once-per-launch "support the developer" nudge, after a short randomised delay. |
...
| `src/windows/Shell/TradingTerminal.App.Basic/Composition/AppDependencyInjection.cs` | 298 | win | TradingTerminal.App.Basic | B | Y | Strategy plug-ins: RSI, Cumulative Delta, plus the signal-mode wrappers |
...
| `src/windows/Shell/TradingTerminal.App.Basic/MainWindow.xaml` | 1120 | win | TradingTerminal.App.Basic | B | N | XAML |
| `src/windows/Shell/TradingTerminal.App.Basic/MainWindowViewModel.cs` | 755 | win | TradingTerminal.App.Basic | B | Y | Surfaces a persistent amber "SIMULATED DATA" banner while the Simulated broker is |
...
| `src/windows/Shell/TradingTerminal.Login/BrokerLoginFormBase.cs` | 291 | win | TradingTerminal.Login | B I P | Y | Two/three-letter square-badge text (e.g. "BN", "IB"). |
...
| `src/windows/Shell/TradingTerminal.Login/Forms/IbLoginFormViewModel.cs` | 145 | win | TradingTerminal.Login | B I P | Y | TWS / IB Gateway must be up — surfaced inside this row |
...
| `src/windows/Shell/TradingTerminal.Login/Forms/NinjaLoginFormViewModel.cs` | 97 | win | TradingTerminal.Login | B I P | Y | NinjaTrader 8 must be up — surfaced inside this row (see the |
...
| `src/windows/Shell/TradingTerminal.Login/LoginViewModel.cs` | 499 | win | TradingTerminal.Login | B I P | Y | The forms as their concrete base type, pre-sorted Keyless → Credentialed → |
...
| `src/windows/Shell/TradingTerminal.Login/LoginWindow.xaml` | 735 | win | TradingTerminal.Login | B I P | N | XAML |
| `src/windows/Shell/TradingTerminal.Login/ServiceDependencyViewModel.cs` | 286 | win | TradingTerminal.Login | B I P | Y | The live state of an external dependency the terminal talks to but |
...
| `src/windows/Shell/TradingTerminal.UI/Controls/BrokerLogo.cs` | 73 | win | TradingTerminal.UI | B I P | Y | Renders a broker's identifying mark, or no image so the caller's monogram |
...
| `src/windows/Shell/TradingTerminal.UI/Diagnostics/PluginFaultWatchdog.cs` | 114 | win | TradingTerminal.UI | B I P | Y | Attaches to |
...
| `src/windows/Shell/TradingTerminal.UI/Strategies/StrategyCardActions.xaml.cs` | 41 | win | TradingTerminal.UI | B I P | Y | Compact tag flyout and safe external-link action shared by all strategy-card editions. |
| `src/windows/Shell/TradingTerminal.UI/Strategies/StrategyCardActions.xaml` | 200 | win | TradingTerminal.UI | B I P | N | XAML |
| `src/windows/Shell/TradingTerminal.UI/Strategies/StrategyCatalogItemViewModel.cs` | 71 | win | TradingTerminal.UI | B I P | Y | The underlying strategy — the catalog's pill converters, Open and Quick-backtest all |
...
| `src/windows/Shell/TradingTerminal.UI/Strategies/StrategyPresentation.cs` | 21 | win | TradingTerminal.UI | B I P | Y | User-authored presentation overrides for a strategy's catalog card — how it is |
...
| `src/windows/Shell/TradingTerminal.UI/Strategies/StrategyPresentationEditorView.xaml` | 100 | win | TradingTerminal.UI | B I P | N | XAML |
| `src/windows/Shell/TradingTerminal.UI/Strategies/StrategyPresentationEditorViewModel.cs` | 93 | win | TradingTerminal.UI | B I P | Y | Clears every field back to the strategy's own compiled metadata (persisted as |
| `src/windows/Shell/TradingTerminal.UI/Strategies/StrategyPresentationStore.cs` | 82 | win | TradingTerminal.UI | B I P | Y | The overrides for a strategy, or |
...
| `src/windows/Shell/TradingTerminal.UI/Theming/ThemeManager.cs` | 442 | win | TradingTerminal.UI | B I P | Y | A selectable app theme — an id, a display name, and the |
