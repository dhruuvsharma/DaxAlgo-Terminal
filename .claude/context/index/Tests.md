...
| `tests/TradingTerminal.Tests.Headless/Backtesting/EngineParityTests.cs` | 101 | win | TradingTerminal.Tests.Headless | dev | Y | Parity gate: the new must reproduce the old |
