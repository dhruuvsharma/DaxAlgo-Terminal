...
```cs
   19: public static class PluginFaultWatchdog
   25: public static IDisposable Attach(
  112: public void Dispose() => Interlocked.Exchange(ref _dispose, null)?.Invoke();
```
...
```cs
   10: public partial class StrategyCardActions : UserControl
   12: public StrategyCardActions()
```
