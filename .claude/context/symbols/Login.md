...
```cs
   ...
   39: public sealed partial class ServiceDependencyViewModel : ObservableObject
   44: public ServiceDependencyViewModel(
   65: public string Name { get; }
   66: public string Purpose { get; }
   67: public string Requirement { get; }
   68: public string HowTo { get; }
   69: public string? StartCommand { get; }
   71: public bool HasStartCommand => !string.IsNullOrWhiteSpace(StartCommand);
   72: public bool CanProbe => _probe is not null;
   74: public string StartActionLabel { get; }
   75: public bool HasStartAction => _startAction is not null;
   78: public async Task RunStartAsync(CancellationToken ct = default)
   98: public async Task CheckAsync(CancellationToken ct = default)
  120: public static async Task<bool> HttpOkAsync(string url, CancellationToken ct)
  135: public static async Task<bool> TcpOpenAsync(string host, int[] ports, CancellationToken ct)
  171: public static Task<bool> ProcessRunningAsync(string processName, CancellationToken ct) => Task.Run(() =>
  186: public static Task<bool> DockerRunningAsync(CancellationToken ct) => Task.Run(() =>
```
