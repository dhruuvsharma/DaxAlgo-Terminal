# TradingTerminal.Core / Research — public API surface
...
## src/windows/Core/TradingTerminal.Core/Research/EnvHash.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Research/EnvResolutionPlan.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Research/IEnvResolverClient.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Research/IPaperIngestClient.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Research/IReplicationConfidenceScorer.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Research/IReproJobStore.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Research/IReproOrchestrator.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Research/IReproSignalBridge.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Research/ISandboxRunner.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Research/MinimalReproPlan.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Research/ReproResult.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Research/ReproSignalKind.cs
```cs
    8: public enum ReproSignalKind
```

## src/windows/Core/TradingTerminal.Core/Research/ReproSignalManifest.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Research/ReproSpec.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Research/ReproStatus.cs
```cs
    8: public enum ReproStatus
```

## src/windows/Core/TradingTerminal.Core/Research/ReproducedSignal.cs
```cs
   15: public sealed record ReproducedSignal(
```

## src/windows/Core/TradingTerminal.Core/Research/SandboxKind.cs
```cs
    8: public enum SandboxKind
```

## src/windows/Core/TradingTerminal.Core/Research/SandboxPolicy.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Research/SandboxQuota.cs
```cs
