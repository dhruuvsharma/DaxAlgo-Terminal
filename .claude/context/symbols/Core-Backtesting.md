# TradingTerminal.Core / Backtesting — public API surface
...
## src/windows/Core/TradingTerminal.Core/Backtesting/BacktestReport.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Backtesting/IStrategyContext.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Backtesting/IStrategyKernel.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Backtesting/Optimization.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Backtesting/Portfolio.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Backtesting/RunSpec.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Backtesting/StrategyKernelRegistry.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Backtesting/StrategyParameterSchema.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Backtesting/StrategyParameters.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Backtesting/Universe.cs
```cs
...
## src/windows/Core/TradingTerminal.Core/Backtesting/VisualTimeline.cs
```cs
